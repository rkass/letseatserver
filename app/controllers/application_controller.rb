class ApplicationController < ActionController::Base
  ...
  def sendRegistrationText(auth_token, phoneNumber, failsafe)
    ...
    @client.account.messages.create({
      :from => '+15162520417',
      :to => phoneNumber,
      :body => "Click this link to confirm your registration and start using Let\'s Eat! www.letseatrecommendations.com/register?auth_token=#{auth_token}    Or, if you're using an iPad, enter the following access code in the field you just used for your phone number: #{code}" 
     })
  end
end
